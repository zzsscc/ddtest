...
var deal401Middleware=function(e){return e.result=e.result.catch(function(e){return"401"==e.code&&(e.docUrl="https://open-doc.dingtalk.com/doc2/detail?spm=0.0.0.0.F3gGdE&treeId=176&articleId=104958&docType=1",e.errorCode="401",e.errorMessage="璁块棶鏉冮檺閿欒",e.tips=["璇风‘淇濆綋鍓嶇殑缃戦〉鐨勬槸鍦ㄤ粠閽夐拤PC绔紝閽夐拤PC modal, 閽夐拤PC slidePanel 鐨勫叆鍙ｆ墦寮€"]),Promise.reject(e)}),e};module.exports=deal401Middleware;


},{}],43:[function(require,module,exports){
var devState=require("./../devState"),tipsMap={notConfig:["浣犺繕鏈皟鐢ㄨ繃config鏂规硶锛岃灏濊瘯璋冪敤DingTalkPC.config鏂规硶鍚庡啀灏濊瘯浣跨敤姝PI"],configIng:["鍦ㄤ綘璋冪敤姝PI鏃讹紝浣犵殑DingTalkPC.config鏂规硶杩樺湪杩愯锛岃妫€鏌ヤ綘鐨凙PI鏂规硶鏄惁鍦≧eady涔嬪悗鎵ц"],configError:["浣犱笂涓€娆＄殑config澶辫触浜嗭紝璇锋煡鐪媍onfig澶辫触鏃ュ織鍚庡啀閲嶆柊灏濊瘯config"],notIncludeAPIList:["浣犲綋鍓嶈皟鐢ㄧ殑鎺ュ彛鏂规硶涓嶅寘鍚湪apiList閲岋紝璇风‘淇滵ingTalkPC.config閲岀殑apiList鏄惁鍖呭惈褰撳墠api鎺ュ彛"],noAuthAPI:["浣犲綋鍓嶈皟鐢ㄧ殑鎺ュ彛鏂规硶鎺堟潈澶辫触锛岃纭繚浣犳槸鍚︽湁鏉冮檺鐢宠姝PI"]},deal404Middleware=function(t){return t.result=t.result.catch(function(e){return"404"==e.code&&(e.docUrl="https://open-doc.dingtalk.com/doc2/detail.htm?spm=a219a.7629140.0.0.dvoU0l&treeId=176&articleId=104955&docType=1#s2",e.errorCode="404",e.errorMessage="鎵句笉鍒�"+t.methodName+"鎺ュ彛鏂规硶",devState.HAD_CONFIG?devState.HAD_CONFIG&&devState.CONFIG_ING&&!devState.CONFIG_ERROR&&!devState.CONFIG_SUCCESS?e.tips=tipsMap.configIng:devState.HAD_CONFIG&&!devState.CONFIG_ING&&devState.CONFIG_ERROR?(e.tips=tipsMap.configError,e.tips.push("config閿欒鏃ュ織:"+JSON.stringify(devState.CONFIG_ERROR_LOG))):devState.HAD_CONFIG&&!devState.CONFIG_ING&&devState.CONFIG_SUCCESS&&(devState.AUTHORIZED_API_LIST.indexOf(t.methodName)<0?e.tips=tipsMap.notIncludeAPIList:devState.UNAUTHORIZED_API_LIST.indexOf(t.methodName)>-1?e.tips=tipsMap.noAuthAPI:e.tips=tipsMap.noAuthAPI):e.tips=tipsMap.notConfig),Promise.reject(e)}),t};module.exports=deal404Middleware;


},{"./../devState":40}],44:[function(require,module,exports){
var deal408Middleware=function(e){return e.result=e.result.catch(function(r){return"408"==r.code&&(r.docUrl="https://open-doc.dingtalk.com/doc2/detail?spm=0.0.0.0.F3gGdE&treeId=176&articleId=104958&docType=1",r.errorCode="408",r.errorMessage="璋冪敤"+e.methodName+"鎺ュ彛鍝嶅簲瓒呮椂",r.tips=["璇锋鏌ョ綉缁滄槸鍚﹀紓甯�"]),Promise.reject(r)}),e};module.exports=deal408Middleware;
...
var logMiddleWare=function(o){return o.result=o.result.catch(function(e){var r='font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; color: red; font-size: 13px; padding: 3px 0 background: #444; border-radius: 4px; line-height: 18px',l='font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 13px; color: #444; padding: 3px 0; line-height: 18px';return console.group("%c璋冪敤 "+o.methodName+" 鏃跺彂鐢熶簡閿欒",r),"string"==typeof e?console.log("閿欒淇℃伅锛�"+e):"object"==typeof e&&(e.errorCode&&console.log("閿欒鐮侊細"+e.errorCode),e.errorMessage&&console.log("閿欒淇℃伅锛�"+e.errorMessage),e.tips&&(console.group("%c甯姪淇℃伅锛�",l),e.tips.forEach(function(o,e){console.log(e+1+"銆�"+o)}),console.groupEnd()),e.docUrl&&console.log("鐩稿叧鏂囨。鍦板潃锛�"+e.docUrl),console.log("杩斿洖閿欒瀵硅薄濡備笅锛�"),console.dir(e)),console.log("濡傛灉浠ヤ笂淇℃伅杩樻湭鑳借В鍐充綘鐨勯棶棰橈紝璇疯闂� https://bbs.aliyun.com/thread/276.html 鍙戝笘鍜ㄨ"),console.groupEnd(),Promise.reject(e)}),o};module.exports=logMiddleWare;
